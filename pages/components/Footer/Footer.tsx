...
const Footer = () => {
  return (
    <div className='w-full h-[800px] mt-[100px] gap-[80px] bg-[#FFFFFF] sm:max-md:w-[428px] sm:max-md:h-[1411px] sm:max-md:mt-[100px] sm:max-md:flex-col'>
      <div className='w-[1120px] h-[82px] justify-between flex sm:max-md:w-full sm:max-md:h-[91px] sm:max-md:gap-16 sm:max-md:flex-col'>
        <div className='w-[500px] h-[51px] ml-28 mt-40 sm:max-md:w-full sm:max-md:h-[91px] sm:max-md:gap-16 sm:max-md:ml-9'>
            <h1 className='w-[500px] h-[27px] font-Roboto font-semibold text-[18px] sm:max-md:w-full sm:max-md:h-[27px] sm:max-md:text-[24px]'>Subscribe to our newsletter</h1>
            <p className='w-[500px] h-[24px] font-Roboto font-normal text-[16px] sm:max-md:w-full sm:max-md:h-[48px] sm:max-md:text-center sm:max-md:pr-40 sm:max-md:text-[20px] sm:max-md:pt-8'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </div>
        <div className='w-[400px] h-[82px] mt-[150px] ml-[250px] sm:max-md:w-[428px] sm:max-md:h-[146px] sm:max-md:gap-16 sm:max-md:ml-5'>
            <div className='w-[400px] h-[48px] sm:max-md:w-full sm:max-md:h-[112px]'>
                ...
                <p className='w-[400px] h-[18px] font-Roboto font-normal text-[12px] mt-2 sm:max-md:w-full sm:max-md:h-[18px] sm:max-md:text-[12px] sm:max-md:ml-20'>By subscribing you agree to with our 
      ...
      <div className='w-[1120px] h-[225px] flex gap-[40px] mt-[300px] ml-32 sm:max-md:mt-[600px] sm:max-md:flex-col sm:max-md:w-full sm:max-md:h-[811px]'>
  ...
  <div className="w-full flex justify-between items-center mt-8 px-28 sm:max-md:flex-col sm:max-md:w-full sm:max-md:h-[114px]">
    <div className='flex gap-4 items-center sm:max-md:flex-col sm:max-md:gap-6'>
      <span className="font-Roboto font-normal text-[14px] sm:max-md:w-[195px] sm:max-md:h-[21px] sm:max-md:text-[12px] sm:max-md:ml-10">2023 Ddsgnr. All rights reserved.</span>
