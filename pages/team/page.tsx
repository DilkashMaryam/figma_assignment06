...
const team = () => {
  return (
    <div className='w-full h-[1049px] bg-[#FFFFFF] sm:max-md:w-[428px] sm:max-md:h-auto'>
      <div className='w-[768px] h-[109px] gap-[357px] mt-[100px] ml-[300px] sm:max-md:w-[428px] sm:max-md:ml-5'>
        <h1 className='font-Roboto font-bold text-[48px] leading-[57.6px] sm:max-md:h-[84px] sm:max-md:text-[42px] sm:max-md:text-center'>Explore Courses By Category</h1>
        <p className='font-Roboto mt-[30px] font-normal text-[18px] leading-[27px] sm:max-md:pt-4 sm:max-md:h-[54px] sm:max-md:text-[20px] sm:max-md:text-center'>Discover a wide range of courses covering a variety of subjects, taught by expert instructors.</p>
      </div>

      <div className='w-full h-[636px] gap-[96px] bg-[#FFFFFF] mt-[100px] sm:max-md:w-full sm:max-md:h-auto sm:max-md:ml-2'>
        <div className='w-full h-[132px] gap-[24px] flex text-center pt-[10px] sm:max-md:flex-col '>
            <div className='w-[410.67px] h-[132px] rounded p-[16px] gap-[32px] bg-[#F7F7F7] flex items-center sm:max-md:w-[400px] sm:max-md:h-auto sm:max-md:mt-8'>
              <Image src="/images/Frame 292.png" alt='pen' width={90} height={90} className='flex-shrink-0 sm:max-md:gap-10 '></Image>
              <div className='ml-4'>
              <h1 className='font-Roboto text-[20px] sm:max-md:text-[18px] leading-[30px] ml-4 font-semibold'>Design & Development</h1>
              <p className='font-Roboto text-[18px] font-normal leading-[27px]'>50+ Courses Available</p>
              </div>
            </div>

            <div className='w-[410.67px] h-[132px] rounded p-[16px] gap-[32px] bg-[#F7F7F7] flex items-center sm:max-md:w-[400px] sm:max-md:h-auto sm:max-md:mt-10'>
        ...
        <button className='w-[155px] h-[48px] rounded border-[1px] gap-8 mt-[50px] ml-[550px] max-md:mt-[450px] sm:max-md:ml-40'>
